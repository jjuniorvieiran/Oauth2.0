...
public class CallbackServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // the authorization server's authorization endpoint will generate code
        ...
        try {
            // the authorization server's token endpoint will generate token
            // with token we can access the protected resource
